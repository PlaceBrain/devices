...
class DevicesHandler(DevicesServiceServicer):
    ...
    async def InvalidateMqttCredentials(  # type: ignore[override]
        self,
        request: devices_pb.InvalidateMqttCredentialsRequest,
        context: grpc.aio.ServicerContext,
        mqtt_auth_service: FromDishka[MqttAuthService],
    ) -> devices_pb.InvalidateMqttCredentialsResponse:
        ...
        return devices_pb.InvalidateMqttCredentialsResponse(success=True)
    ...
    async def UpdateDeviceStatus(  # type: ignore[override]
        self,
        request: devices_pb.UpdateDeviceStatusRequest,
        context: grpc.aio.ServicerContext,
        devices_service: FromDishka[DevicesService],
    ) -> devices_pb.UpdateDeviceStatusResponse:
        ...
        try:
            ...
            return devices_pb.UpdateDeviceStatusResponse(success=success)
        except NotFoundError as e:
            await context.abort(grpc.StatusCode.NOT_FOUND, str(e))
            raise
    ...
    async def GetAllThresholds(  # type: ignore[override]
        self,
        request: devices_pb.GetAllThresholdsRequest,
        context: grpc.aio.ServicerContext,
        sensors_service: FromDishka[SensorsService],
        devices_service: FromDishka[DevicesService],
    ) -> devices_pb.GetAllThresholdsResponse:
        ...
        for sensor, thresholds in sensor_threshold_pairs:
            if sensor.device_id not in device_cache:
                device_cache[sensor.device_id] = await devices_service.get_place_id_for_device(
                    sensor.device_id
                )
            place_id = device_cache[sensor.device_id]
            result.append(
                devices_pb.SensorWithThresholds(
        ...
        return devices_pb.GetAllThresholdsResponse(sensors=result)
